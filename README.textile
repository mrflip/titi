...
We can define a super-simple twitter user and status model:
...
Now, writing an adaptor to activity stream format is straightforward and compact:
...
Here's example output. _note: this isn't canonical activity streams format: the XML serialization needs work_
